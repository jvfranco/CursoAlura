...
//		ComparadorParaConta comparador = new ComparadorParaConta();
//		lista.sort(comparador);
		
//		lista.sort(new ComparadorParaConta());
		...
		ComparadorNomeConta comparadorString = new ComparadorNomeConta();
		
//		lista.sort(comparadorString);
...
class ComparadorNomeConta implements Comparator<Conta>{
...
class ComparadorParaConta implements Comparator<Conta> {
